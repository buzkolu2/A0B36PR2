...
/**
 * okno menu obsahující seznam klientů, seznam faktur a tlačítka přidat, odebrat
 * a prohlížet
 *
 * @author Fragolka
 */
public class OknoMenu extends Frame {
    ...
    OknoMenu() {
        ...
        for (Faktura f : Menu.faktury) {
            if (f.getKlient() == null) {
                faktury.pridejPrvek(Integer.toString(f.getId())
                        + ", klient neznámý");
            } else {
                faktury.pridejPrvek(Integer.toString(f.getId())
    ...
    class SmazatFakturuAL implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (idx >= 0) {
                ...
                Menu.odstranitFakturu(Menu.faktury.get(idx));
//                try {
...
//                    }
    ...
    class ProhlizetFakturuAL implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            int idx = OknoMenu.faktury.vybranyPrvek();
            if (idx >= 0) {
                Faktura f = Menu.faktury.get(idx);
                new ProhlizeniFaktury(f, idx).setVisible(true);
            }
        }
    }
    ...
    class SmazatKlientaAL implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (idx >= 0) {
                ...
                Menu.odstranitKlienta(Menu.klienti.get(idx));
