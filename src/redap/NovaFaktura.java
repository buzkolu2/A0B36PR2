...
/**
 * okno pro vytvoření nové faktury, přidává, ubírá položky, nastavuje datum plnění
 *
 * @author Fragolka
 */
public class NovaFaktura extends Frame {
    ...
    NovaFaktura() {
        ...
        Label hlavicka = new Label("Nová Fakutra");
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (idx < 0) {
                ...
                try {
                    ...
                    OknoMenu.faktury.pridejPrvek(Integer.toString(novaFaktura.getId())
                    ...
                    JOptionPane.showMessageDialog(null,
                            "Chybné datum, datum musí být ve formátu dd.mm.rrrr", "Chyba", JOptionPane.OK_OPTION);
                }
            }
